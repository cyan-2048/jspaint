	...
	const menus = {
		[localize("&File")]: [
			{
				...
				speech_recognition: ["new", "new file", "new document", "create new document", "create a new document", "start new document", "start a new document"],
				action: () => {
					file_new();
				},
			...
			},
			{
				...
				speech_recognition: ["upload to imgur", "upload image to imgur", "upload picture to imgur"],
				action: () => {
			...
			MENU_DIVIDER,
			{
				...
				speech_recognition: ["preview print", "print preview", "show print preview", "show preview of print"],
				action: () => {
					print();
				},
			...
			MENU_DIVIDER,
			{
				...
				speech_recognition: ["exit application", "exit paint", "close paint window"],
				action: () => {
					$postMessage({ func: "exit" });
				},
		...
		[localize("&Edit")]: [
			...
			},
			{
				...
				speech_recognition: ["paste a file", "paste from a file", "insert a file", "insert an image file"],
				action: () => {
				...
				submenu: [
					...
					},
					{
						...
						action: () => {
							...
							let mag = Math.min((rect.width - margin) / main_canvas.width, (rect.height - margin) / main_canvas.height);
		...
		[localize("&Colors")]: [
			...
			},
			{
				...
				speech_recognition: ["get colors", "load colors", "load color palette", "load palette", "load color palette file", "load palette file", "load list of colors"],
				action: async () => {
			...
			},
			{
				...
				speech_recognition: ["save colors", "save list of colors", "save color palette", "save palette", "save color palette file", "save palette file"],
				action: () => {
		...
		[localize("E&xtras")]: [
			...
			},
			{
				...
				speech_recognition: ["repo on github", "project on github", "show the source code", "show source code"],
				action: () => {
